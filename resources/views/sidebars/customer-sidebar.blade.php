<nav id="nav-sidebar">
    <div class="scrollbar">
        <ul>
            ...
            <li class="{{ Request::is('customer/bookings') ? 'active' : '' }}">
                <a href="{{route('customer.bookings')}}">
                    <i class="fas fa-plus-circle"></i>
                    <span>{{__('messages.new_booking')}}</span>
                </a>
            </li>
            <li class="{{ Request::is('customer/my-bookings') ? 'active' : '' }}">
                <a href="{{route('customer.mybookings')}}">
            ...
            <li class="menu-title">
                <span class="flex items-center">
                    <i class="fas fa-hands-helping mr-2 text-xs"></i>
                    Services
                </span>
            </li>
